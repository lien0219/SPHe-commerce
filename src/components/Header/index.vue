...
export default {
  ...
  methods: {
    ...
    goSearch() {
      ...
      //面试题1：路由传参参数（对象写法）path是否可以结合params参数一起使用？
      //答：路由跳转传参的时候，对象的写法可以是name、path形式，但是需要注意的是，path这种写法不能与params参数一起使用
      //this.$route.push({path:'/serch',params:{keyword:this.keyword},query:{k:this.keyword.toUpperCase()}});
     
     //面试题2：如何指定params参数可传可不传？
     //如果路由要求传递params参数，但是你就不传递params参数，发现一个问题，URL会有问题
